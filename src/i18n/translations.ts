...
export const translations = {
  en: {
    ...
    tallyCupCounters: 'CUP COUNTERS',
    tallyCupCountersHint: 'Tap + for each cup sold · Long-press +5',
    tallyPerCup: 'per cup',
  ...
  hi: {
    ...
    tallyCollected: 'जमा',
    tallyCupCounters: 'कप काउंटर',
    tallyCupCountersHint: 'बिके हर कप के लिए + दबाएं · लंबे दबाव से +5',
